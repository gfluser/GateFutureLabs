...
function smtp_mail($dzEmailTo, $dzEmailFrom, $dzEmail, $dzMailSubject, $dzMailMessage)
{
    ...
    $mail->Username   = 'aletjacob111@gmail.com';                   //SMTP username
    $mail->Password   = 'vjnawkutyzempaso';                        //SMTP password
...
try {
    if (!empty($_POST)) {
		...
		if($_POST['dzToDo'] == 'Appointment')
		{
			...
			$dzMailSubject = 'Gate|Appointment Form: A Person want to contact';
			$dzMailMessage	= 	"
								A person want to contact you: <br><br>
								Name: $dzName<br/>
								Email: $dzEmail<br/>".$dzPhoneMessage."
